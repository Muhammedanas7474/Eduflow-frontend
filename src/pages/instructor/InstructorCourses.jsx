        ...
        const matchesTab =
            activeTab === "All Courses" ? true :
                activeTab === "Published" ? course.is_active :
                    activeTab === "Drafts" ? !course.is_active : true;

        return matchesSearch && matchesTab;
    });

    // Counts for Tabs
    const publishedCount = courses.filter(c => c.is_active).length;
    const draftsCount = courses.filter(c => !c.is_active).length;
    const allCount = courses.length;

    const tabs = [
        { name: "All Courses", count: allCount },
        { name: "Published", count: publishedCount },
        { name: "Drafts", count: draftsCount },
    ];
        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2.5 bg-[#00cc7d] text-black font-bold rounded-lg hover:bg-[#00b36e] transition-colors shadow-[0_0_15px_rgba(0,255,157,0.3)] text-sm">
                        <Icons.Plus />
                        New Course
                    </button>
                </div>
